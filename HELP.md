...
|:--------------- |:----------- |:----------- |:-------------------------- |
| `data/` | Data | `storage:mlops_ideal_demo/data/` | `/mlops_ideal_demo/data/` |
| `modules/` | Python modules | `storage:mlops_ideal_demo/modules/` | `/mlops_ideal_demo/modules/` |
| `config/` | Configuration files | `storage:mlops_ideal_demo/config/` | `/mlops_ideal_demo/config/` |
| `notebooks/` | Jupyter notebooks | `storage:mlops_ideal_demo/notebooks/` | `/mlops_ideal_demo/notebooks/` |
| `results/` | Logs and results | `storage:mlops_ideal_demo/results/` | `/mlops_ideal_demo/results/` |
...
After the storage folders have been created, run `neuro-flow upload data` from the a local machine as well. This command pushes local files stored in `./data` into the `storage:mlops_ideal_demo/data` volume mounted to your development environment's `/project/data`.
